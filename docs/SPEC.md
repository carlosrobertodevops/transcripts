...
SaaS transcrição: upload média → fila assíncrona → Whisper local/Groq/OpenAI → edição com segmentos editáveis. Rotas Elysia montadas em Next.js via catch-all `/api/[...path]`.
...
PostgreSQL 16 + Drizzle ORM. Real: `src/db/schema.ts`. Enums reais em `drizzle/0007_expand_user_roles.sql`.
...
| `name`         | text      | YES      | —       |                   |
| `avatarUrl`    | text      | YES      | —       |                   |
| `role`         | enum      | NO       | 'viewer'| 'super_admin' \| 'admin' \| 'pro' \| 'viewer' |
  ...
  "items": [
    {
      ...
      "title": "...",
      "operationName": "...",
      "operationDate": "2026-05-10T...",
      "transcriptionDate": "2026-05-11T...",
      "analysis": "...",
      "transcriptHtml": null,
      "status": "processing",
      "position": 0,
...
```json
{
  ...
  "title": "Operação XYZ",
  "operationName": "xyz-123",
  "operationDate": "2026-05-10T00:00:00.000Z",
  "transcriptionDate": "2026-05-11T00:00:00.000Z",
  "analysis": "...",
  "transcriptHtml": null,
  "status": "pending",
  "position": 1,
...
- MIME: audio/_ or video/_ (or known extension)
